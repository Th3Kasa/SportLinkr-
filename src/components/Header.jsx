...
export default function Header({ coords, radius, onRadiusChange, showControls = false }) {
  ...
  return (
    <header
      className="sticky top-0 z-30 backdrop-blur-xl bg-bg/80 border-b border-white/5"
      role="banner"
    >
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
        <div className="flex items-center gap-3 h-14">
          ...
          <Link
            to="/"
            className="flex items-center gap-2 mr-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent rounded-lg"
          ...
          {/* Location chip */}
          {coords && (
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs text-white/60 shrink-0">
          ...
          {showControls && onRadiusChange && (
            <button
              className="lg:hidden w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-accent"
